...
| :--- | :--- | :--- |
| [`u3v-sdk-2.2.0-windows-x64.zip`](./InnoMaker_SDK_Support_Win_Linux_Mac_Python/u3v-sdk-2.2.0-windows-x64.zip) | Windows 10/11 x64 | C/C++ SDK + Qt6 viewer, fully self-contained |
| [`u3v-sdk-2.2.0-linux-x64.tar.gz`](./InnoMaker_SDK_Support_Win_Linux_Mac_Python/u3v-sdk-2.2.0-linux-x64.tar.gz) | Ubuntu 22.04+ x64 | C/C++ SDK + viewer (system Qt6 + libusb) |
| [`u3v-sdk-2.2.0-linux-arm64.tar.gz`](./InnoMaker_SDK_Support_Win_Linux_Mac_Python/u3v-sdk-2.2.0-linux-arm64.tar.gz) | Pi 5 / Jetson Orin Nano | ARM64 counterpart of the Linux x64 package |
| [`u3v-sdk-2.2.0-macos-arm64.zip`](./InnoMaker_SDK_Support_Win_Linux_Mac_Python/u3v-sdk-2.2.0-macos-arm64.zip) | Apple Silicon (M1–M4) | C/C++ SDK + `u3v_viewer.app` |
| [`u3v-sdk-2.2.0-macos-x64.zip`](./InnoMaker_SDK_Support_Win_Linux_Mac_Python/u3v-sdk-2.2.0-macos-x64.zip) | Intel Mac | Intel counterpart of the macOS arm64 package |
| [`u3v-sdk-2.2.0-python.zip`](./InnoMaker_SDK_Support_Win_Linux_Mac_Python/u3v-sdk-2.2.0-python.zip) | All platforms | Python 3.8+ package; bundles native libraries for every platform |
...
- **Switch to InnoMaker SDK (WinUSB):** Run `tools\zadig-2.9.exe` from the `u3v-sdk-2.2.0-windows-x64` package, select the camera device, choose **WinUSB**, and click **Install Driver**.
...
| [`InnoMaker_SDK_Support_Win_Linux_Mac_Python/DELIVERY_OVERVIEW.md`](./InnoMaker_SDK_Support_Win_Linux_Mac_Python/DELIVERY_OVERVIEW.md) | Full SDK documentation: installation, API reference, code examples |
