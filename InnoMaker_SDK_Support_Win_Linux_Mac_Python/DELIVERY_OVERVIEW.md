...
| `u3v-sdk-2.2.5.1-python.zip`        | All five OS/arch above | 1.1 MB | Python 3.8+ package; bundles native libraries for every platform in one archive |
...
## 6. Python Package (`u3v-sdk-2.2.5.1-python.zip`)
...
**Windows:**
```bat
:: 1. Extract u3v-sdk-2.2.5.1-python.zip
...
4. **Choosing a package**
   ...
   - Python / ML / CV teams, headless capture, scripting →
     `u3v-sdk-2.2.5.1-python.zip` (single file covers all five platforms)
